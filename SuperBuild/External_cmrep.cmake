...
# Sanity checks
if(DEFINED cmrep_DIR AND NOT EXISTS ${cmrep_DIR})
  message(FATAL_ERROR "cmrep_DIR [${cmrep_DIR}] variable is defined but corresponds to nonexistent directory")
endif()
...
if(NOT DEFINED ${proj}_DIR AND NOT ${SUPERBUILD_TOPLEVEL_PROJECT}_USE_SYSTEM_${proj})
  ...
  ExternalProject_SetIfNotDefined(
    ...
    "${EP_GIT_PROTOCOL}://github.com/JolleyLab/cmrep.git"
    QUIET
    )

  ExternalProject_SetIfNotDefined(
    ${SUPERBUILD_TOPLEVEL_PROJECT}_${proj}_GIT_TAG
    "b6a509df3ae233eeddb3244fcefae61ca8ab2c98"
    QUIET
    )
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_CACHE_ARGS
      ...
      -Dcmrep_INSTALL_RUNTIME_DIR:STRING=${Slicer_INSTALL_THIRDPARTY_LIB_DIR}
      -Dcmrep_INSTALL_LIBRARY_DIR:STRING=${Slicer_INSTALL_THIRDPARTY_LIB_DIR}
    ...
    # For now we just directly include source code from cmrep (not building cmrep).
    CONFIGURE_COMMAND ""
    BUILD_COMMAND ""
    INSTALL_COMMAND ""
    DEPENDS
